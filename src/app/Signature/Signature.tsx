...
class Signature extends React.Component {
  constructor(props) {
    ...
    this.handleModalToggle = (isModelOpen1) => {
      this.setState({
        isModelOpen1: !this.state.isModelOpen,
      });
    };
    this.handleModalToggleClose = (isModelOpen1) => {
      this.setState({
        isModelOpen1,
      });
    };
                  ...
                  <CardActions>
                    <Dropdown
                      ...
                      dropdownItems={[
                        ...
                        <DropdownItem key="trash" onClick={() => this.handleModalToggle()} position="right">
                          <PenIcon />
                          Edit
                        </DropdownItem>,
                      ]}
